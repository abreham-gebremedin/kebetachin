     ...
     <span class="navbar-toggler-icon"></span>
       ...
       <div class="collapse navbar-collapse" id="navbar1"  >
        <ul class="navbar-nav ml-auto nav-links-btn">
           ...
           <li class="nav-item"><a class="nav-link" href="{{ url('/fproposals') }}">Proposals</a></li>
           <li class="nav-item"><a class="nav-link" href="{{url("/fcontracts")}}">Contracts</a></li>
           <li class="nav-item"><a class="nav-link" href="/fmessages">Message</a></li>
            <ul class="navbar-nav ml-auto  nav-links-btn">
