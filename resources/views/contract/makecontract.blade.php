...
<div class="card">
    ...
    <section class="testimonial " id="testimonial" style="margin:20px">
        ...
        <h2 class="pb-6">Make contract</h2>


        <div class="jumbotron abbr">

            <form id="quickForm" action="/make/contract" method="POST">
                @csrf
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td> <input type="date" class="form-control" min="{{date("Y-m-d")}}" name="start_date"
                                    max="3000-12-31" id="textFrom" placeholder="Date earned"></td>

                        </tr>
                        <tr>
                            <th scope="col">End Date</th>
                            <td> <input id="textTo" type="date" class="form-control" min="{{date("Y-m-d", strtotime('tomorrow'))}}" name="end_date"
                            ...
                            <td>
                                  <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label class="custom-control-label" for="exampleCheck1">I have <strong>read and agree</strong> to the <strong  >Contract</strong>.</label>
                                        </div>
                                             
                                    </div>

                                <button type="button" class="btn btn-success btn-block text-light text-lg" data-toggle="collapse"
                                  data-target="#readcontract">Read and Accept contract term! <span
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="readcontract" class="collapse col-12">
                                    ...
                                    "created_at":"2020-04-18T09:56:28.000000Z"}}},"freelancer":{"id":11,"userid":2,"overview":"khkjhjkhjkhjkhjkhjkhjkhj","lid":27,"payment_type_id":1,"proname":"Web
                                    developer","created_at":"2020-05-03T17:14:31.000000Z","updated_at":"2020-05-03T17:14:31.000000Z"},"payment_type":{"id":2,"type_name":"Fixed
                                    price","created_at":null,"updated_at":null}}
        ...
        <script type="text/javascript">
            ...
            $('#quickForm').validate({
              ...
              messages: {
                end_date: {
                  required: "You should set strart date",
